...
```
cd existing_repo
git remote add origin https://gitlab.com/eazytraining-group/gitlab-cicd-project.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/eazytraining-group/gitlab-cicd-project/-/settings/integrations)
